...
function ProjectPreviewImgRight(props) {
  return (
    <div className="project-preview">
      ...
      <div className="project-preview__img--right project-preview__img--desktop">
        <img className="project__img" src={props.imgSrc} loading="lazy" alt="Facebook like app"/>
      </div>
    </div>  
  )
}
  
export default ProjectPreviewImgRight;